...
@trades_blueprint.route('/tradeProperties/<int:property1_id>/<int:property2_id>', methods=['PUT'])
...
@trades_blueprint.route('/suggestionTradeProperties/<int:owner1_id>/<int:owner2_id>', methods=['GET'])
...
@trades_blueprint.route('/suggestionTradePropertiesAllUsers', methods=['GET'])
